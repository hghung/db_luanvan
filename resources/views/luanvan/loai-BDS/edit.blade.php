					...
					<div class="row">
						...
						<div class="col-lg-12 " style="height: 100px !important">
							<div class="breadcrumb_content style2">
								<h2 class="breadcrumb_title">Sữa loại bất động sản</h2>
								<p>Chúng tôi rất vui khi gặp bạn!</p>
							</div>
						</div>
						<div class="col-lg-12">
                            <form class="form" method="POST"  action="{{ route('loaiBDS.edit.post',['id' => $BDS->id]) }}" enctype="multipart/form-data"> 
                            {{ csrf_field() }}
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-12 col-xl-12">
                                                    <div class="my_profile_setting_input form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="loaiBDS" value="{{ $BDS->ten_loaiBDS }}" >
                                                    </div>
                                                </div>
