					...
					<div class="row">
						...
						<div class="col-lg-12 " style="height: 100px !important">
							<div class="breadcrumb_content style2">
								<h2 class="breadcrumb_title">Cập nhật phương thức thanh toán</h2>
								<p>Chúng tôi rất vui khi gặp bạn!</p>
							</div>
						</div>
						<div class="col-lg-12">
                            <form class="form" method="POST"  action="{{ route('phuongthuc.edit.post',['id' => $phuongthuc->id]) }}" enctype="multipart/form-data"> 
                            {{ csrf_field() }}
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-8 col-xl-8">
                                                    <div class="my_profile_setting_input form-group">
                                                        ...
                                                        <input type="text" value="{{ $phuongthuc->ten_phuongthuc }}" class="form-control" name="phuongthuc"  >
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-lg-6 col-xl-4">
                                                    <div class="my_profile_setting_input ui_kit_select_search form-group">
                                                        ...
                                                        <select class="selectpicker" data-width="100%" name="trangthai">
                                                            @if($phuongthuc->trangthai->id == 1)
                                                            <option value="1">Active</option>
                                                            <option value="2">Disable</option>
                                                            @elseif($phuongthuc->trangthai->id == 2)
                                                            <option value="2">Disable</option>
                                                            <option value="1">Active</option>
                                                            @endif
                                                ...
                                                <div class="col-lg-12 col-xl-12">
                                                    <div class="my_profile_setting_input form-group">
                                                        ...
                                                        &nbsp &nbsp &nbsp
                                                        <img style="width:80px; height:23px;" src="{{ asset($phuongthuc->path_logo) }}">
